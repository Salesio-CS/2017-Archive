...
class TM1637:											
        ...
        def Scroll( self, data ):											
                for i in range(0,4):											
                        ...
                        self.Show(data2);											
                        time.sleep(0.5);											
                        data2 = [data[1], data[2], data[3], 0];											
                        self.Show(data);											
                        time.sleep(0.5);											
                        data2 = [data[2], data[3], 0, 0];											
                        self.Show(data);											
                        time.sleep(0.5);											
                        data2 = [data[3], 0, 0, 0];											
                        self.Show(data);											
...
Display = TM1637(GPIO_CLK, GPIO_DIO, BRIGHT_TYPICAL)					
						Å@BRIGHT_DARKESTÇ‚BRIGHT_HIGHESTÇ…ïœçXÇµÇƒÇ≠ÇæÇ≥Ç¢ÅB					
Display.Clear()											
											
try:											
  while True:											
    data1 = time.ctime()[11:13] + time.ctime()[14:16]		
    data2 = [int(data1[0:1]), int(data1[1:2]), int(data1[2:3]), int(data1[3:4])]
    Display.Show(data2)											
    sec = int(time.ctime()[17:19])											
    if sec%2 == 0:											
